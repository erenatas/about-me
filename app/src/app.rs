      ...
      <Router>
        <section class="about-section">
          ...
          <Routes fallback=|| NotFoundPage>
            ...
            <Route path=path!("/resume") view=Resume ssr=leptos_router::SsrMode::PartiallyBlocked />
            <ParentRoute path=path!("/blog") view=Blog>
              <Route path=path!("") view=BlogList />
              <Route path=path!(":id") view=BlogContent />
            </ParentRoute>
          </Routes>
        </section>
      </Router>
      ...
      <div class="about-content">
        ...
        <div class="developer-info">
          ...
          <a class="developer-tagline">
            "A site reliability engineer who loves tinkering" <span class="accent-dot">.</span>
            <span class="glitch-text" title="999">
              999
            </span>
          </a>
        </div>
